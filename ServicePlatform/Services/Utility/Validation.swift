...
public struct Validation {
  ...
  public static func emptyValidation(text: String) -> Bool {
    return !text.isEmpty
  }
  
//  public static func titleValidation(text: String) -> Bool {
//    return !text.isEmpty && text != Constant.CString.EnterTitle
//  }
//  
//  public static func titleCategoryValidation(text: String) -> Bool {
//    return !text.isEmpty && text != Constant.CString.EnterCategoryTitle
//  }
