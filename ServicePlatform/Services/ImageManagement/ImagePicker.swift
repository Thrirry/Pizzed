      ...
      return self.promptFor(alert: UIAlertController(title: nil,
        ...
        case .UploadImage:
          _ = UIImagePickerController.rx.createWithParent(self.vc) { picker in
            ...
            .take(1)
            .map {
              $0[editable ? UIImagePickerControllerEditedImage : UIImagePickerControllerOriginalImage] as? UIImage
            }
        ...
        case .ScanImage:
          _ = UIImagePickerController.rx.createWithParent(self.vc) { picker in
            ...
            .take(1)
            .map { $0[editable ? UIImagePickerControllerEditedImage : UIImagePickerControllerOriginalImage] as? UIImage }
            .subscribe(onNext: { (img) in
              complete.onNext(img)
            })
        }
