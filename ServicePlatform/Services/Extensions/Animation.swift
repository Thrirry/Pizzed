...
public extension UIView {
  ...
  public func shake(duration: CFTimeInterval = 0.01, repeatCount: Float = Float.infinity, reverse: Bool = true, values: [Any]? = nil) {
    ...
    transformAnim.timingFunction = CAMediaTimingFunction(name: kCAMediaTimingFunctionLinear)
  ...
  public func slideInAnimation(duration: Double = 1, subType: String = kCATransitionFromBottom) {
    alpha = 1
