...
class MenuTableViewCell: UITableViewCell {
    ...
    func setupLayout() {
        ...
        containerView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.7).isActive = true
        ...
        titleLableView.heightAnchor.constraint(equalTo: heightAnchor, multiplier: 0.22).isActive = true
        ...
        titleLableView.font = UIFont(name: "Dosis-SemiBold", size: fontSizeRightBar)
