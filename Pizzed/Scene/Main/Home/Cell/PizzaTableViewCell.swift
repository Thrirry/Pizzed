...
//        newsBtn.setBackgroundImage(#imageLiteral(resourceName: "New"), for: .normal)
        ...
        contentItemView.heightAnchor.constraint(equalTo: contentContainerView.heightAnchor, multiplier: 0.48).isActive = true
        ...
        orderView.heightAnchor.constraint(equalTo: contentContainerView.heightAnchor, multiplier: 0.17).isActive = true
    ...
    func formatTextTVContent(named: UITextView) {
        named.sizeToFit()
//        named.scrollRangeToVisible(NSMakeRange(0, 0))
//        named.contentOffset.y = 0
//        named.setContentOffset(.zero, animated: false)
